...
\t\t<avio-logger:log doc:name="Logger" config-ref="AVIO_Logger_Config" message="#[payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298a" />
\t\t<logger level="WARN" doc:name="Logger" message="#['Improper Value in Payload: ' ++ payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298b" />
\t\t<avio-logger:log level="WARN" doc:name="Logger" config-ref="AVIO_Logger_Config" message="#['Improper Value in Payload: ' ++ payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298b" />
\t\t<logger level="INFO" doc:name="Logger" message="#['Improper Value in Payload: ' ++ payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298c" />
\t\t<avio-logger:log doc:name="Logger" config-ref="AVIO_Logger_Config" message="#['Improper Value in Payload: ' ++ payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298c" />
\t\t<logger level="INFO" doc:name="Logger" message="#[payload.cheeseWheels]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298d" />
\t\t<avio-logger:log doc:name="Logger" config-ref="AVIO_Logger_Config" message="#[payload.cheeseWheels]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298d" />
\t\t<logger level="DEBUG" doc:name="Logger" message="#[payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298e" />
\t\t<avio-logger:log level="DEBUG" config-ref="AVIO_Logger_Config" doc:name="Logger" message="#[payload]" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298e" />
...
\t\t<avio-logger:log doc:name="Logger" config-ref="AVIO_Logger_Config" message="#['payload']" doc:id="6a676a90-4f3a-48c5-90af-358e8c1c298f" />
\t</flow>
</mule>'''
}
