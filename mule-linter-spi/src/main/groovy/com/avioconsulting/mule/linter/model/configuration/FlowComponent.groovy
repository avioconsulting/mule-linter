...
class FlowComponent extends MuleComponent {
    ...
    final static ComponentIdentifier IDENTIFIER_FLOW = new ComponentIdentifier(COMPONENT_NAME_FLOW, COMPONENT_NAMESPACE)
    final static ComponentIdentifier IDENTIFIER_SUBFLOW = new ComponentIdentifier(COMPONENT_NAME_SUBFLOW, COMPONENT_NAMESPACE)
    ...
    static boolean accepts(ComponentIdentifier identifier) {
        return IDENTIFIER_FLOW.equals(identifier) || IDENTIFIER_SUBFLOW.equals(identifier)
    }
}
